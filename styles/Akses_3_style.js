...
var style_Akses_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (value >= 7.000000 && value <= 12.800000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 12.800000 && value <= 18.600000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 16.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 18.600000 && value <= 24.400000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 16.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 24.400000 && value <= 30.200000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 16.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 30.200000 && value <= 36.000000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 16.0 + size,
