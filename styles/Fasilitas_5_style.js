...
var style_Fasilitas_5 = function(feature, resolution){
    ...
    if (value >= 23.000000 && value <= 82.200000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 82.200000 && value <= 141.400000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 16.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 141.400000 && value <= 200.600000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 16.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 200.600000 && value <= 259.800000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 16.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 259.800000 && value <= 319.000000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 16.0 + size,
