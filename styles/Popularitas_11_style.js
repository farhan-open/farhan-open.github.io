...
var style_Popularitas_11 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Popularitas");
    var labelText = "";
    size = 0;
    ...
    if (value >= 1192.000000 && value <= 1990.400000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1990.400000 && value <= 2788.800000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 16.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2788.800000 && value <= 3587.200000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 16.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 3587.200000 && value <= 4385.600000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 16.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 4385.600000 && value <= 5184.000000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 16.0 + size,
