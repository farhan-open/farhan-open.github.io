...
var style_Monetary_7 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Monetary");
    var labelText = "";
    size = 0;
    ...
    if (value >= 1.022900 && value <= 2.669520) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2.669520 && value <= 4.316140) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 16.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 4.316140 && value <= 5.962760) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 16.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 5.962760 && value <= 7.609380) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 16.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 7.609380 && value <= 9.256000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 16.0 + size,
