...
var style_Reputasi_10 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Reputasi");
    var labelText = "";
    size = 0;
    ...
    if (value >= 4.230000 && value <= 4.344000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 4.344000 && value <= 4.458000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 16.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 4.458000 && value <= 4.572000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 16.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 4.572000 && value <= 4.686000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 16.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 4.686000 && value <= 4.800000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 16.0 + size,
